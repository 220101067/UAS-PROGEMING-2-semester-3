                ...
                <div id="contentToLock">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <small class="text-danger">
                                        <h6>Silakan Mengambil KRS Persemester ? </h6>
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-header">
                        <div class="container mt-1">
                            <div class="container mt-1">
                                <a href="index.php?halaman=krs" class="btn btn"> <i class="fas fa-book-reader"></i> KRS</a>
                            ...
                            <center>
                                <form id="semesterForm">
                                    <select id="semester" name="semester" onchange="redirectToPage()">
                                        <option value="ganjil">2023/2024 Ganjil</option>
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        while ($row = $sql->fetch()) {
                                            ...
                                            // Validasi untuk menampilkan hanya data dengan semester 1
                                            if ($result['total'] == 0 && intval($row['semester']) == 1) {
                                                // Tambahkan validasi untuk semester 3 atau 5
                                                ...
                                                <td>{$row['kelas']}</td>
                                                <td>
                                                    <form method='POST' action='index.php?halaman=krs'>
